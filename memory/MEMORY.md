...
## Session Savepoints (latest 3 — 47 older ones in _archive/)
...
- [session_savepoint_2026-04-28b_drip-license-absorption.md](session_savepoint_2026-04-28b_drip-license-absorption.md) — drip Matteo PR #1 unblock reply + license memo absorbed. 6 commits on phase-0-novelty-gateway: specs ingest, atlas+decode framing sweep, /methodology rewrite (stale AUROCs out, Aurora model card path in), capability matrix swap (7-endpoint → competitor compare), /for-researchers run-based pricing (seats out, $499/$2,499/$25k tiers), /creator-agreement license-conformance fix (drip ownership of "trained models" + "underlying ip" deleted, Aurora-licensee boundary baked into the contract). Aurora is licensor, drip is licensee + operator — output-only, non-sublicensable, no white-label, no embed, no fine-tuning. Partner reply ready in Downloads/Telegram Desktop/. Branch 60 → 66 ahead.
