// Browser-runtime extractor. No Chrome APIs. Exposes window.__typeuiExtract().
// Ported from bergside/design-md-chrome content-script.js (MIT).
(function installExtractor() {
  if (window.__typeuiExtract) return;

  window.__typeuiExtract = function extractStylesFromPage() {
